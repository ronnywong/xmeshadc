// $Id: Stk500.C,v 1.1.4.3 2007/01/26 06:05:45 pipeng Exp $
...
TStk500::SPrgPart TStk500::prg_part[] = {
  ...
  {"ATmega1281",
   {0x08, 0xD7, 0xA0, 0x00},
   {0x42, 0xf0, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x04, 0xff, 0xff, 0xff,
    0xff, {0x01, 0x00}, {0x10, 0x00}, {0x00, 0x02, 0x00, 0x00}, 0x20}
  }, 
  {"ATmega2561",
  	{0x08, 0xD7, 0xA0, 0x00},
  	{0x42, 0xf1, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x04, 0xff, 0xff, 0xff,
  	 0xff, {0x01, 0x00}, {0x10, 0x00}, {0x00, 0x04, 0x00, 0x00}, 0x20}
  },
...
void TStk500::Initialize()
{
  ...
  if (bMIB510 = (strcmp(GetCmdParam("-dprog"), "mib510") == 0) || 
  				(strcmp(GetCmdParam("-dprog"), "mib520") == 0 )) {
...
void TStk500::Cleanup() {
  ...
  if ((strcmp(GetCmdParam("-dprog"), "mib510") == 0) || (strcmp(GetCmdParam("-dprog"), "mib520") == 0))  {
    memcpy(buf, IspMode, sizeof(IspMode));
    buf[8] =  0;
    Send(buf, sizeof(IspMode), sizeof(IspMode_Reply));
    if (memcmp(buf, IspMode_Reply, sizeof(IspMode_Reply)) != 0) {
