// $Id: Avr.h,v 1.1.4.2 2007/01/26 06:04:33 pipeng Exp $
...
/* Has 4 bytes of fuse bits (ATmega1281).  */
 #define AVR_FUSE_HIGH_EXT       0x0800
...
#define AVR_M1281 (AVR_BYTE_POLL | AVR_PAGE_POLL | AVR_LOCK_BOOT | AVR_FUSE_RD \
  	      | AVR_FUSE_NEWWR | AVR_CAL_RD | AVR_FUSE_HIGH | AVR_FUSE_EXT | AVR_FUSE_HIGH_EXT)
