 ...
 *
 * $Id: XMDA300M.nc,v 1.1.2.4 2007/04/26 20:08:07 njain Exp $
 */
  ...
  static void initialize() 
   ...
   static void start() 
	...
	if(call PlugPlay())
	{
	    ...
	    //record[0] = call Sample.getSample(0,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT | EXCITATION_33 | EXCITATION_ALWAYS_ON);

	    //record[1] = call Sample.getSample(1,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT | EXCITATION_25 | EXCITATION_ALWAYS_ON);
            
	    //record[2] = call Sample.getSample(2,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT | EXCITATION_50 | EXCITATION_ALWAYS_ON);
	    ...
	    record[7] = call Sample.getSample(7,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT);
            
	    record[8] = call Sample.getSample(8,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT);
            
	    record[9] = call Sample.getSample(9,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT);
            
	    record[10] = call Sample.getSample(10,ANALOG,ANALOG_SAMPLING_TIME,SAMPLER_DEFAULT);
 ...
 */
	...
	{          
		...
		case ANALOG:              
			...
			case 7:
                tmppack=(XDataMsg *)packet.data;
			    tmppack->xData.datap7.diff0 =data ;
			    atomic {msg_status|=0x01;}
			    break;

			case 8:   
                tmppack=(XDataMsg *)packet.data;
			    tmppack->xData.datap7.diff1 =data ;
			    atomic {msg_status|=0x02;}
			    break;
             
			case 9:
                tmppack=(XDataMsg *)packet.data;
			    tmppack->xData.datap7.diff2 =data ;
			    atomic {msg_status|=0x04;}
			    break;
              
			case 10:
                tmppack=(XDataMsg *)packet.data;
			    tmppack->xData.datap7.diff3 =data ;
		...
		case BATTERY:            
            atomic {
            		tmppack=(XDataMsg *)packet.data;
			tmppack->xData.datap7.vref =data ;
			msg_status|=0x10;}
		    if(!bBoardOn)
		    {
		    post send_radio_msg();
		...
		case HUMIDITY:            
            atomic {
            		tmppack=(XDataMsg *)packet.data;
			tmppack->xData.datap7.humid =data ;
		    msg_status|=0x20;}
		    break;
		...
		case TEMPERATURE:          
            atomic {
            		tmppack=(XDataMsg *)packet.data;
			tmppack->xData.datap7.humtemp =data ;
		    msg_status|=0x40;}
		    break;
