 ...
 *
 * $Id: XSensorMDA320M.nc,v 1.3.4.1 2007/04/26 20:26:39 njain Exp $
 */
 ...
 * PACKET #1 (of 4)
 * ----------------
 *  msg->data[0] : sensor id, MDA320 = 0x90
 ...
 * PACKET #2 (of 4)
 * ----------------
 *  msg->data[0] : sensor id, MDA300 = 0x90
...
******************************************************/	
	...
	if(call PlugPlay())
	{
	    ...
	    record[22] = call Sample.getSample(5,DIGITAL,DIGITAL_SAMPLING_TIME,DIG_LOGIC | EVENT );//| EEPROM_TOTALIZER);
	                                    
	    record[23] = call Sample.getSample(6,DIGITAL,DIGITAL_SAMPLING_TIME,DIG_LOGIC | EVENT);
            
	    record[24] = call Sample.getSample(7,DIGITAL,DIGITAL_SAMPLING_TIME,DIG_LOGIC | EVENT);                                
