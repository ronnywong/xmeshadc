 ...
 *
 * $Id: pinMacros.h,v 1.1.2.2 2007/04/26 22:02:34 njain Exp $
 */
 ...
 */
 ...
 /* Last Modified: $Date: 2007/04/26 22:02:34 $
  *
  * $Log: pinMacros.h,v $
  * Revision 1.1.2.2  2007/04/26 22:02:34  njain
  ...
  *
  * Revision 1.1.2.1  2007/01/12 10:51:17  lwei
  * CVS: Please enter a Bugzilla bug number on the next line.
  * BugID:
  * CVS: Please enter the commit log message below.
  ...
  * CVS: ----------------------------------------------------------------------
  *
  * Revision 1.1  2006/11/26 03:28:32  barry
  * Add micazb platform files
  * Barry
  *
  * Revision 1.2  2006/07/10 22:09:09  rkapur
  * Updating MAIN to 2.1 tree
  *
  * Revision 1.1.2.1  2006/04/04 02:10:43  husq
  * Resolving the tag mismatch and fix the uart0 driver and TimerJiffy
  *
  * Revision 1.1  2006/03/23 04:25:34  husq
