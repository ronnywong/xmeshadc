 ...
 *
 * $Id: config.h,v 1.2.4.2 2007/04/25 23:43:22 njain Exp $
 */
...
enum ApplicationID {
    ...
    TOS_RADIO = 3,			// CC1000 radio parameters
    //TOS_CC2420 = 4,			// CC2420 radio parameters
    TOS_XMESHAPP = 5,			// CC2420 radio parameters    
...
typedef struct {
    ...
    uint8_t bytes;			// number of bytes in the entire parameter block.
					...
					// physical layers
} __attribute__ ((packed)) FlashVersionHeader_t;
...
} __attribute__ ((packed)) FlashVersionData_t;
...
} __attribute__ ((packed)) FlashVersionBlock_t;
...
////////////////////////////////////////
// Parameter IDs for TOS_RADIO 'application'
////////////////////////////////////////
enum RadioParamID{
    TOS_RADIO_TUNE_HZ = 1,		// 32 bits of frequency * 1,000,000 ex: 995,918,000
    TOS_RADIO_LOWER_HZ = 2,		// 32 bits of frequency * 1,000,000 ex: 916,000,000
    TOS_RADIO_UPPER_HZ = 3,		// 32 bits of frequency * 1,000,000 ex: 933,000,000
    TOS_RADIO_RF_POWER = 4, // 8 bit hex between 0x00 and 0xFF show radio transmit power, ref. CC1000 datasheet
    TOS_RADIO_RF_CHANNEL = 5, // 8 bit hex show radio preset channel, ref. CC1000const.h
};
...
////////////////////////////////////////
// Parameter IDs for TOS_XMESHAPP 'application'
////////////////////////////////////////
enum xmeshappParamID {
    TOS_XMESH_TIMER_RATE = 1,			// 32 bits of XMESH apps' timer_rate
};
...
enum {
    ...
    CONFIG_RF_CHANNEL = APP_PARAM_ID(TOS_RADIO,TOS_RADIO_RF_CHANNEL),
    CONFIG_RF_POWER = APP_PARAM_ID(TOS_RADIO,TOS_RADIO_RF_POWER),
    CONFIG_XMESHAPP_TIMER_RATE = APP_PARAM_ID(TOS_XMESHAPP,TOS_XMESH_TIMER_RATE),    
};
