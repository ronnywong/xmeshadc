 ...
 *
 * $Id: XMeshBinaryRouter.nc,v 1.9.2.4 2007/04/25 23:44:11 njain Exp $
 */
...
implementation 
{
  ...
  ShimLayerM.XOtapLoaderActual->XMeshC.XOtapLoader;
  ...
  XMeshC.XOtapTimer -> TimerC.Timer[unique("Timer")];  
...
#elif defined(PLATFORM_MICAZC) \
  || defined(PLATFORM_M2110) 
  BoundaryM.RF230Control ->RF230ControlM;
#endif
}
