 ...
 *
 * $Id: SamplerM.nc,v 1.1.4.4 2007/04/27 05:16:15 njain Exp $
 */
    ...
    static inline void setparam_digital(int8_t i,uint8_t param)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                call Dio6.setparam(param);
                break;
            case 7:
                call Dio7.setparam(param);
                break;
            default:
            }
            return;
...
task void sigbatt()
{
	signal Sample.dataReady(0,BATTERY,batvalue); 
}
