 ...
 *
 * $Id: sensorboard.h,v 1.1.2.3 2007/04/27 05:52:13 njain Exp $
 */
...
enum {
  ...
  TOSH_SWITCH0_ADDR = 72, // 1001'000(r/w)
  TOSH_SWITCH1_ADDR = 73, // 1001'001(r/w)

  // I2C Taos Photo Sensor Switch Address
  TOSH_PHOTO_ADDR = 57,   // 0111'001(r/w)

 // I2C EEPROM Switch Address
  TOSH_EEPROM_ADDR = 85,  // 1010'101(r/w)
